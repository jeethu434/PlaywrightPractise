...
- Name: example.spec.js >> @Web has title
...
Call log:
  ...
  - waiting for locator('.cartSection h3')
    2 × locator resolved to <h3 _ngcontent-xwv-c41="">ZARA COAT 3</h3>
      - unexpected value "ZARA COAT 3"
        ...
        - generic [ref=e44]:
          ...
          - generic [ref=e46]:
            - link "Star microsoft/playwright on GitHub" [ref=e47] [cursor=pointer]:
              - /url: https://github.com/microsoft/playwright
              - text: Star
            - link "87k+ stargazers on GitHub" [ref=e49] [cursor=pointer]:
