...
```
Error: locator.hover: Error: strict mode violation: locator('.dropdown-toggle') resolved to 2 elements:
    1) <a href="#" data-toggle="dropdown" class="dropdown-toggle">…</a> aka getByRole('link', { name: 'More ' })
    2) <a href="#" data-toggle="dropdown" class="dropdown-toggle">…</a> aka getByText('More').nth(1)

Call log:
  - waiting for locator('#courses-iframe').contentFrame().locator('.dropdown-toggle')
  ...
  - group "iFrame Example" [ref=e174]:
    ...
    - iframe [ref=e176]:
      - generic [ref=f4e2]:
        - banner [ref=f4e3]:
              ...
              - list [ref=f4e12]:
                ...
                - listitem [ref=f4e16]:
                  - link "" [ref=f4e17] [cursor=pointer]:
                    ...
                    - generic [ref=f4e18]: 
              - link " Register" [ref=f4e20] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
                - generic [ref=f4e21]: 
                - text: Register
              - link " Login" [ref=f4e23] [cursor=pointer]:
          ...
          - generic [ref=f4e27]:
            - link [ref=f4e30] [cursor=pointer]:
              - /url: /
            - navigation [ref=f4e32]:
              - list [ref=f4e34]:
                - listitem [ref=f4e35]:
                  - link "Home" [ref=f4e36] [cursor=pointer]:
                    - /url: /
                - listitem [ref=f4e37]:
                  - link "Courses" [ref=f4e38] [cursor=pointer]:
                    - /url: https://courses.rahulshettyacademy.com/courses
                - listitem [ref=f4e39]:
                  - link "NEW All Access plan" [ref=f4e40] [cursor=pointer]:
                    - /url: lifetime-access
                - listitem [ref=f4e41]:
                  - link "NEW Learning paths" [ref=f4e42] [cursor=pointer]:
                    - /url: learning-path
                - listitem [ref=f4e43]:
                  - link "Mentorship" [ref=f4e44] [cursor=pointer]:
                    - /url: mentorship
                - listitem [ref=f4e45]:
                  - link "Job Support" [ref=f4e46] [cursor=pointer]:
                    - /url: consulting
                - listitem [ref=f4e47]:
                  - link "Practice" [ref=f4e48] [cursor=pointer]:
                    - /url: practice-project
                - listitem [ref=f4e49]:
                  - link "Blog" [ref=f4e50] [cursor=pointer]:
                    - /url: https://rahulshettyacademy.com/blog/
                - listitem [ref=f4e51]:
                  - link "More " [ref=f4e52] [cursor=pointer]:
                    - /url: "#"
                    - text: More
                    - generic [ref=f4e53]: 
                  - text: 
        - generic [ref=f4e54]:
          - generic [ref=f4e59]:
            - img "First slide" [ref=f4e60]
            - generic [ref=f4e62]:
              - heading "An Academy to Learn Earn & Shine in your QA Career" [level=2] [ref=f4e63]:
                - generic [ref=f4e64]:
                  - text: An Academy to
                  - strong [ref=f4e65]: Learn Earn & Shine
                  - text: in your QA Career
              - heading "World-class tutorials on Selenium, Rest Assured, Cypress, Appium, Postman, Cucumber, SoapUI, Playwright, Jmeter, Jira, and many more. Join our courses now to get the best job opportunity." [level=3] [ref=f4e66]
              - link "JOIN NOW" [ref=f4e68] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
          - generic [ref=f4e72]:
            - generic [ref=f4e74]:
              - generic [ref=f4e76]: 
              - generic [ref=f4e77]: 600,000 +
              - heading "Students" [level=4] [ref=f4e78]
            - generic [ref=f4e80]:
              - generic [ref=f4e82]: 
              - generic [ref=f4e83]: 30 +
              - heading "Courses" [level=4] [ref=f4e84]
            - generic [ref=f4e86]:
              - generic [ref=f4e88]: 
              - generic [ref=f4e89]: 257,000 +
              - heading "Ratings" [level=4] [ref=f4e90]
            - generic [ref=f4e92]:
              - generic [ref=f4e94]: 
              - generic [ref=f4e95]: 30 +
              - heading "Projects" [level=4] [ref=f4e96]
          - generic [ref=f4e99]:
            - heading "why we are Leaders in market?!" [level=2] [ref=f4e100]
            - generic [ref=f4e101]:
              - list [ref=f4e103]:
                - listitem [ref=f4e104]: The academy is led by Rahul Shetty, a Test evangelist and Test architect with over 10+ years in the IT industry.
                - listitem [ref=f4e105]: Rahul Shetty is a pioneer and authority in software testing space.
                - listitem [ref=f4e106]: He has taught over 300,000 students in 195 countries from across the world.
                - listitem [ref=f4e107]: All our courses are based on Real Time Project based where you learn real skill which are readily transferable to your work project.
                - listitem [ref=f4e108]: Our courses are guaranteed to help you reach your career goals and develop your automation skills
                - listitem [ref=f4e109]: Life time access, Learn at your own pace and updates are Free for Life.
              - list [ref=f4e111]:
                - listitem [ref=f4e112]: Wide coverage of topics like Selenium, Appium, Cucumber BDD, Cypress, Protractor, RestAPI, SoapUI and JMeter etc.
                - listitem [ref=f4e113]: His mentorship program is most after in the software testing community with long waiting period.
                - listitem [ref=f4e114]: Once under his mentorship, you are preparing yourself for long term success with his expert guidance and support.
                - listitem [ref=f4e115]: Lot of companies have already benefited from our consulting services.
                - listitem [ref=f4e116]: We are essentially a Full Stack QA consulting and Training company and we got you covered for your test implementation and training needs.
          - generic [ref=f4e118]:
            - generic [ref=f4e119]:
              - heading "Our Students" [level=2] [ref=f4e120]
              - generic [ref=f4e121]:
            ...
            - generic [ref=f4e122]:
              - generic [ref=f4e124]:
                ...
                - generic [ref=f4e154]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f4e155]
                  - generic [ref=f4e156]: Student of software testing
                  - generic [ref=f4e157]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f4e158]:
                    - generic [ref=f4e159]: 
                    - generic [ref=f4e160]: 
                    - generic [ref=f4e161]: 
                ...
                - generic [ref=f4e167]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f4e168]
                  - generic [ref=f4e169]: student of selenium
                  - generic [ref=f4e170]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive.And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f4e171]:
                    - generic [ref=f4e172]: 
                    - generic [ref=f4e173]: 
                    - generic [ref=f4e174]: 
                ...
                - generic [ref=f4e180]:
                  - text: 
                  - heading "Zubair Rowley" [level=4] [ref=f4e181]
                  - generic [ref=f4e182]: Student of software testing
                  - generic [ref=f4e183]: Guys, I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field, but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f4e184]:
                    - generic [ref=f4e185]: 
                    - generic [ref=f4e186]: 
                    - generic [ref=f4e187]: 
                ...
                - generic [ref=f4e193]:
                  - text: 
                  - heading "Sania Wynn" [level=4] [ref=f4e194]
                  - generic [ref=f4e195]: student of selenium
                  - generic [ref=f4e196]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive. And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f4e197]:
                    - generic [ref=f4e198]: 
                    - generic [ref=f4e199]: 
                    - generic [ref=f4e200]: 
                ...
                - generic [ref=f4e206]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f4e207]
                  - generic [ref=f4e208]: Student of software testing
                  - generic [ref=f4e209]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f4e210]:
                    - generic [ref=f4e211]: 
                    - generic [ref=f4e212]: 
                    - generic [ref=f4e213]: 
                ...
                - generic [ref=f4e219]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f4e220]
                  - generic [ref=f4e221]: student of selenium
          ...
          - generic [ref=f4e229]:
            - generic [ref=f4e231]:
              - heading "Featured Courses" [level=2] [ref=f4e233]
              - generic [ref=f4e236] [cursor=pointer]:
                - generic: Dollar($) Rupee(₹)
            - link "VIEW ALL COURSES" [ref=f4e239] [cursor=pointer]:
              - /url: https://courses.rahulshettyacademy.com/courses
        - generic [ref=f4e242]:
          - generic [ref=f4e243]:
            - heading "JOIN OUR ACADEMY" [level=2] [ref=f4e244]
            - generic [ref=f4e245]: Sign up today and get access to "Core Java for Testers" & "QA Resume Preparation" Courses for FREE.
          - link "JOIN NOW" [ref=f4e248] [cursor=pointer]:
            - /url: https://courses.rahulshettyacademy.com/sign_up
        - contentinfo [ref=f4e249]:
          - generic [ref=f4e252]:
            - generic [ref=f4e254]:
              - text: All Right Reserved
              - link "RahulShettyAcademy" [ref=f4e255] [cursor=pointer]:
                - /url: "#"
              - text: © 2026
            - list [ref=f4e257]:
              - listitem [ref=f4e258]:
                - link "About Us" [ref=f4e259] [cursor=pointer]:
                  - /url: /about-my-mission
              - listitem [ref=f4e260]:
                - link "Contact Us" [ref=f4e261] [cursor=pointer]:
                  - /url: contact-us
              - listitem [ref=f4e262]:
                - link "Privacy Policy" [ref=f4e263] [cursor=pointer]:
                  - /url: /privacy
        - text: 
  - table [ref=e178]:
    - rowgroup [ref=e179]:
...
```ts
  ...
  14 |     await page.locator("#checkBoxOption1").check();
  15 |     await expect(page.locator("#checkBoxOption1")).toBeChecked();
  16 |     await page.locator("#checkBoxOption1").uncheck();
  17 |     expect(await page.locator("#checkBoxOption1").isChecked()).toBe(false);
  18 |     await page.selectOption('#dropdown-class-example','option3');
  19 |     await page.locator("#autocomplete").fill('India');
  20 |     await page.locator('#ui-id-3').click();
  21 |     
  22 |     await page.locator("#mousehover").hover();
  23 |     await page.getByText('Reload').click();
  24 |     await page.pause();
  25 |     const locator = page.frameLocator("#courses-iframe").locator('.dropdown-toggle');
> 26 |     await locator.hover();
     |                   ^ Error: locator.hover: Error: strict mode violation: locator('.dropdown-toggle') resolved to 2 elements:
  27 | 
  28 | 
  29 | 
