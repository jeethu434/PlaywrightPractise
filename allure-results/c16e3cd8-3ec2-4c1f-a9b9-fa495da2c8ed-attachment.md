...
```ts
  ...
  16 |     await page.pause();
  17 |     await page.locator("#checkBoxOption1").uncheck();
> 18 |     await expect(page.locator("#checkBoxOption1").isChecked).toBe(false);
     |                                                              ^ Error: expect(received).toBe(expected) // Object.is equality
  19 | })
  20 | 
```