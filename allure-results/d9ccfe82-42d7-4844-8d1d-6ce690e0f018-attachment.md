...
- Name: demo.spec.js >> Place order for different datasets ZARA COAT 3
...
Error: locator.waitFor: Error: strict mode violation: locator('.cartSection h3') resolved to 2 elements:
    1) <h3 _ngcontent-hvl-c41="">ZARA COAT 3</h3> aka getByRole('heading', { name: 'ZARA COAT' })
    2) <h3 _ngcontent-hvl-c41="">iphone 13 pro</h3> aka getByRole('heading', { name: 'iphone 13 pro' })
