...
```
TypeError: expect( Total Amount Collected: 296 ).toContain(296) // indexOf

Matcher error: expected value must be a string if received value is a string

Expected has type:  number
Expected has value: 296
Received has type:  string
Received has value: " Total Amount Collected: 296 "
```
...
> 13 |      expect(await page.locator(".totalAmount").textContent()).toContain(amount);
     |                                                               ^ TypeError: expect( Total Amount Collected: 296 ).toContain(296) // indexOf
  14 | })
  15 | 
```